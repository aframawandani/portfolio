        ...
        <div className="container">
          <div className="flex flex-col md:grid md:grid-cols-2 items-center gap-8">
            ...
            <div className="relative flex flex-col">
              <Image className="absolute top-[10%] w-[30vmin]" src="/portfolio/assets/images/logo-outline.svg" width={16} height={32} alt="Logo" />
              <Image className="relative z-[1] border-b border-solid border-[--primary]" src="/portfolio/assets/images/hero.png" width={496} height={424} alt="Aframawandani" />
        ...
        <div className="container">
          ...
          <div className="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="flex flex-col border border-[--gray]">
              <Image className="w-full h-auto lg:w-[329px] lg:h-[162px]" src="/portfolio/assets/images/siberaca.png" width={329} height={162} alt="SIBERACA" />
            ...
            <div className="flex flex-col border border-[--gray]">
              <Image className="w-full h-auto lg:w-[329px] lg:h-[162px]" src="/portfolio/assets/images/dhgtk.png" width={329} height={162} alt="DHGTK" />
            ...
            <div className="flex flex-col border border-[--gray]">
              <Image className="w-full h-auto lg:w-[329px] lg:h-[438]" src="/portfolio/assets/images/ketikweb.png" width={329} height={438} alt="DHGTK" />
            ...
            <div className="flex flex-col border border-[--gray]">
              <Image className="w-full h-auto lg:w-[329px] lg:h-[438]" src="/portfolio/assets/images/servicerollingdoormalang.png" width={329} height={438} alt="DHGTK" />
              <div className="border-t border-[--gray] p-2 text-[--gray]">Typescript Next React Tailwind</div>
              <div className="flex flex-col gap-4 border-t border-[--gray] p-4 text-[--gray]">
                <h3 className="text-2xl text-white font-[500]">DHGTK</h3>
        ...
        <div className="container">
          ...
          <div className="relative md:grid md:grid-cols-2 gap-8">
            <div className="absolute md:relative min-h-[300px] w-full">
              <Image className="absolute top-[30%] left-[70%] min-w-[14vmin]" src="/portfolio/assets/images/logo-outline.svg" width={16} height={32} alt="Whatsapp" />
        ...
        <div className="container">
          ...
          <div className="relative flex flex-col md:flex-row items-center lg:items-start gap-8">
            <div className="flex flex-col gap-8 text-4 text-[--gray]">
              ...
              <p>Transforming my creativity and knowledge into a web app has been my passion for over a year. I have actively contributed to streamlining our school's workflow by automating tasks and digitizing records to reduce paperwork. I always strive to learn about the newest technologies and frameworks.</p>
              <div><LinkButton href="/contact">More =&gt;</LinkButton></div>
            </div>
            <img className="lg:mt-[-128px] max-w-[340px] border-b border-[--primary]" src="/portfolio/assets/images/about-me.png" />
          </div>
        </div>
      </section>
            ...
            <div className="flex flex-col gap-4 border border-[--gray] p-4">
              ...
              <div className="flex flex-col items-start gap-2">
                <a className="flex items-center gap-2 text-[--gray]" href="https://wa.me/6289512292756">
                  <Image src="/portfolio/assets/images/whatsapp.svg" width={32} height={32} alt="Whatsapp" />
                  <span>089512292756</span>
                </a>
                <a className="flex items-center gap-2 text-[--gray]" href="mailto:aframawandani@gmail.com">
                  <Image src="/portfolio/assets/images/email.svg" width={32} height={32} alt="Email" />
